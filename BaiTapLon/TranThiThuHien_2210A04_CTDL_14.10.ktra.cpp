...
void xoaSach(ListS S)   // xoa 2 sach dau
{
    NodeS *p;
    Sach x;
    p = Get_node(x);
...
void khachVip(ListHD H)
{
    NodeHD *p;
    int x;
    cout << "\nNhap x: ";
    cin >> x;
    cout << "\n\t\t\tThong tin khach hang vip" << endl;
	cout << endl << setw(6)  << left  << "MaHD"
                 << setw(24) << left  << "TenSach"
                 << setw(10) << right << "SoLuong"
                 << setw(10) << right << "DonGia"
                 << setw(15) << right << "ThanhTien"
                 << setw(15) << right << "VIP" << endl;
    cout << setfill('-');
    cout << setw(80) << "-" << endl;
    cout << setfill(' ');
	for(p = H.Head; p != NULL; p = p->next)
		...
		switch(n)
		{
			...
			case 3:
                menuHD:
                {
                    ...
                    cout << "\n10.Thong tin khach hang VIP";
                    cout << "\n11.Luu file danh sach";
                    cout << "\n12.Doc file danh sach";
                    cout << "\n13.Tro lai menu chinh";
                    cout << "\n0. Thoat chuong trinh";
                    cout << "\nMoi ban chon: "; cin >> c;
                    switch(c)
                    {
